...
import com.prata.bff_agendador.business.UsuarioService;
...
@Tag(name = "Usuário", description = "Cadastro de login e usuários")
...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioDTOResponse> salvaUsuario(@RequestBody UsuarioDTORequest usuarioDTO ) {
       return ResponseEntity.ok(usuarioService.salavaUsuario(usuarioDTO));
    }
    ...
    @GetMapping
    @Operation(summary = "Buscar dados de Usuários por Email", description = "Buscar dados usuário")
    ...
    @PutMapping
    @Operation(summary = "Atualizar Dados de Usuários por Email", description = "Atualiza dados usuário")
    @ApiResponse(responseCode = "200", description = "Usuário encontrado")
